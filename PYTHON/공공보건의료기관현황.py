...
data = pd.read_csv('./지리정보시각화/보건복지부_공공보건 의료기관 현황_20161231.csv',encoding='cp949',engine='python')
print(data.head())
...
# draw_blockMap(data_all, 'count','행정구역별 공공보건의료 기관수', 'Blues')/
